({
    ...
    title: 'b-form-select',
    head: [
        { elem: 'css', url: '_15fixed_bem.css', ie: false },
        { elem: 'css', url: '_15fixed_bem.ie6.css', ie: 'IE 6' },
        { elem: 'css', url: '_15fixed_bem.ie7.css', ie: 'IE 7' },
        { elem: 'css', url: '_15fixed_bem.ie8.css', ie: 'IE 8' },
        { elem: 'css', url: '_15fixed_bem.ie9.css', ie: 'IE 9' },
        { block: 'i-jquery', elem: 'core' },
        { elem: 'js', url: '_15fixed_bem.js' }
    ],
    content: {
        ...
        content: [
            ...
            },
            {
                ...
                content: {
                    block: 'b-form-select',
                    name: 'mail',
                    mods: { size: 'l', theme: 'grey', layout: 'fixed' },
                    content: [
                        {
                            block: 'b-form-button',
                            type: 'button',
